...
class StripeOrder extends React.Component{
  constructor(props){
    super(props);
    this.empty = [];
    this.stripe = Stripe(); //Insert Test Public Key from Stripe
    ...
    return (
      ...
      <form>
        <div className="group">
          <label>
            <span>Email</span>
            <input className="field" type="email" ref="email" placeholder="your@email.com" required/>
          </label>
        </div>
          ...
          <label>
            <span>Full Name</span>
            <input className="field" type="text" ref="name" placeholder="chow main" required/>
          </label>


          <label>
            <span>Address</span>
            <input className="field" type="text" ref="address" placeholder="666 satan st." required/>
          </label>

          <label>
            <span>City</span>
            <input className="field" type="text" ref="city" placeholder="hell" required/>
          </label>

          <label htmlFor="state">
            <span>State</span>
            <select className="field" ref="state" required>
          ...
          <label>
            ...
            <input className="field" type="text" ref="zip_code" placeholder="66666" required/>
          </label>
          </div>
